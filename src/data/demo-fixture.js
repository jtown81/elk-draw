...
export function loadDemoData(userId) {
    ...
    localStorage.setItem(`sd-elk:user-config:${userId}`, JSON.stringify({ preferencePoints: 11, tagType: 'any_elk' }));
}
/**
 * Get record count for demo data.
 */
export function getDemoRecordCount() {
    return DEMO_RECORDS.length;
}
/**
 * Get unique units in demo data.
 */
export function getDemoUnitCount() {
