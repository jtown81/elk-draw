 ...
 */
export const BLACK_HILLS_UNITS = [
    // H1 — Northeast corner
    {
        unitName: 'H1A',
        tagType: 'any_elk',
 ...
 */
export const ALL_UNIT_BOUNDARIES = [
    ...BLACK_HILLS_UNITS,
    ...PRAIRIE_UNITS,
    ...CSP_UNITS,
];
